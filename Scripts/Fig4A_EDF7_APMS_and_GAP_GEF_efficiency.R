...
cairo_pdf(file = 'Figure4_Multispecificity/APMS_and_biophysics_combined/kinetics_vs_AP-MS_semicircle_plot.pdf', family = "Arial Unicode MS", width = 2.2, height = 2.6)
plot
dev.off()
