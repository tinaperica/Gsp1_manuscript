...
supplemental_directory <- 'Revisions/Supplementary_Figures/Supplementary_File_1/Supplementary_File_1_Figures/'
...
plot_grid(gap_kcat_plot, gef_kcat_plot, gap_Km_plot, gef_Km_plot, align = c('v', 'h'), nrow = 2) +
  draw_plot(gef_Km_plot_zoom, x = 0.6, y = 0.22, width = 0.39, height = 0.32)
ggsave(file.path(extended_directory, '/EDF_6/Ext_Fig6ABCD_gap_and_gef_kcat_and_Km_supp_barplots.pdf'), width = 7.2, height = 5.3)
...
ggsave(filename = file.path(extended_directory, "/EDF_6/Ext_Fig6_e_GAP_GEF_combined_barplot_kcat_over_Km.pdf"), height = 3, width = 6.3)
...
intrinsic_hydrolysis %>% 
  ...
  theme(text = element_text(size = 6, family = 'Helvetica'), 
        ...
        axis.ticks = element_line(size = 0.1),
        legend.background = element_rect(size = 0.1, linetype = "solid", colour = "gray"))
ggsave(file.path(extended_directory, '/EDF_7/Ext_Fig7A_intrinsic_hydrolysis_barplot.pdf'), height = 3, width = 3.5)
