...
mutant_groups <- 
  list('I' = c('D79S', 'T34Q', 'T34E', 'K101R', 'T34G', 'D79A'),
       'II' = c('T34A', 'Q147E', 'R108I', 'R108L', 'R78K', 'Y157A', 'H141E'),
       'III' = c('H141R', 'R108Y', 'R108Q', 'R108G', 'Y148I', 'H141I', 'R112A', 'R112S', 'G80A')) %>% 
  stack() %>% 
...
ggsave('Revisions2/Fig4C/Sina.pdf', height = 1.5, width = 2.5)
dev.off()
