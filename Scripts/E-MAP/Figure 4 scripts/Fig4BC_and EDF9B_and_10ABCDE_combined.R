...
pdf(str_c('Revisions/Extended_Figures/EDF_9/Ext_Data_Fig_9b.pdf'), width = 3.55, height = file_height-sinaplot_height)
print(combn_plots)
dev.off()
# 
...
combn_plots <- plot_grid(plot[["Gsp1 partner"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf('Revisions/Extended_Figures/EDF_10/Ext_Fig10a.pdf', width = 3.3, height = file_height)
print(combn_plots)
dev.off()
...
combn_plots <- plot_grid(plot[["transcription regulation and mediator complex"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf('Revisions/Extended_Figures/EDF_10/Ext_Fig10b.pdf', width = 3.3, height = file_height)
print(combn_plots)
dev.off()


file_height <- barplot_fixed_height + plot[["CVT pathway mitochondria and vacuole"]][['height']] + plot[["actin and polarity"]][['height']]
combn_plots <- plot_grid(plot[["CVT pathway mitochondria and vacuole"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf('Revisions/Extended_Figures/EDF_10/Ext_Fig10c.pdf', width = 3.3, height = file_height)
print(combn_plots)
dev.off()
