...
set.seed(2017)
### output directory
# output_directory <- 'Revisions2/Figure_Files/Figure4'
output_directory <- 'Final_Formatting/temp/Figure4'
### input files
...
mut_groups <- list('I' = c('D79S', 'T34Q', 'T34E', 'K101R', 'D79A', 'T34G'),
...
mutant_groups_for_sina <- 
  list('I' = c('D79S', 'T34Q', 'T34E', 'K101R', 'D79A', 'T34G'),
       'II' = c('T34A', 'Q147E', 'R108I', 'R108L', 'G80A', 'Y157A', 'H141E'),
       'III' = c('H141R', 'R108Y', 'R108Q', 'R108G', 'Y148I', 'H141I', 'R112A', 'R112S', 'R78K')) %>% 
  stack() %>% 
...
barplot_fixed_height <- 2.3
sinaplot_height <- 0.65
...
pdf(str_c(output_directory, '/Ext_Data_Fig_9b_OLD.pdf'), width = 3.55, height = file_height-sinaplot_height)
print(combn_plots)
dev.off()
# 
...
combn_plots <- plot_grid(plot[["Gsp1 partner"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf(str_c(output_directory,'/Ext_Fig9a.pdf'), width = 3.3, height = file_height)
print(combn_plots)
dev.off()
...
combn_plots <- plot_grid(plot[["transcription regulation and mediator complex"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf(str_c(output_directory, '/Ext_Fig9b.pdf'), width = 3.3, height = file_height)
print(combn_plots)
dev.off()
...
combn_plots <- plot_grid(plot[["CVT pathway mitochondria and vacuole"]][['fdr']],
                         ...
                         rel_heights = c(
                           ...
                           1))
pdf(str_c(output_directory, '/Ext_Fig9c.pdf'), width = 3.3, height = file_height)
print(combn_plots)
dev.off()
