...
output_directory <- 'Figure4_Multispecificity/E-MAP_MS_and_biophysics_combined/heatmap_and_barplot_output/Revision2_statistics_check'
...
all_corr <- filtered_correlations %>% 
...
### use all correlations, but as control, also check that it is the same with corr_nr
corr <- nr_corr   
