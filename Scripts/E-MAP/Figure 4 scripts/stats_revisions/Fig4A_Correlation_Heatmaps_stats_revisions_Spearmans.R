...
col.hc <- clustfn(t(corr_mat), dist_method = 'spearman', clust_method = 'ward.D2')
...
subtree <- col.dend[[1]]
lbls <- labels(subtree)
col.dend[[1]] <- rotate(subtree, c('D79S','T34Q','T34E','K101R','D79A','T34G'))

# rotate group II
subtree <- col.dend[[2]][[1]]
lbls <- labels(subtree)
col.dend[[2]][[1]] <- rotate(subtree, c('T34A','Q147E','R108I','R108L','G80A','Y157A','H141E','H141I'))


# rotate group III
subtree <- col.dend[[2]][[2]]
lbls <- labels(subtree)
col.dend[[2]][[2]] <- rotate(subtree, c('H141R','R108Y','R108Q','R108G','Y148I','R112A','R112S','R78K'))
  ...
  decorate_annotation(annot,
    {
      ...
      x_star = c(11.54, 14.54, 20.08, 21.08)
      y_star = rep(0.6, 4)
      # draw star
...
# save heatmap
pdf('Revisions2/Fig_and_analysis_for_StatReviewer/SuppFig18_4A_Corr_Pvalue_Heatmap_Spearman.pdf', width = 3.7, height = 4.5)
draw(pval_heatmap)
